...
<head>
  <title>GennadySX-Web Developer</title>
  ...
  <link href="<?php echo e(asset('css/default.css')); ?>" rel="stylesheet" media="screen">
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <!-- Logo text or image -->
        <a class="navbar-brand" href="index.html">GennadySX</a>
          ...
          <div class="item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animated fadeInDown">Gennady Sabirovsky</h2>
                <p class="animated fadeInUp">I am a Web Developer and student.</p>
      ...
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            ...
            <p>I’ve been building unique digital products, platforms, and experiences for the past 2 years.</p>
          </div>
        </div>
      </div>
  ...
  <section id="bottom-widget" class="home-section bg-white">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="contact-widget wow bounceInUp">
            ...
            <h5>Call</h5>
            <p>
              +1 917 809 8681<br> +7 999 157 1858
        ...
        <div class="col-md-4">
          <div class="contact-widget wow bounceInRight">
            ...
            <h5>Email</h5>
            <p>
              the@gennadysx.com<br />htcucell@gmail.com
            </p>
          </div>
        </div>
      </div>
      <div class="row mar-top30">
        <div class="col-md-12">
          <h5>I am on social networks</h5>
          <ul class="social-network">
            <li><a href="https://www.facebook.com/gennadysx" target="_blank">
                <span class="fa-stack fa-2x">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-facebook fa-stack-1x fa-inverse"></i>
                </span></a>
            </li>
            <li><a href="https://linkedin.com/in/gennadysx" target="_blank">
                <span class="fa-stack fa-2x">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-linkedin fa-stack-1x fa-inverse"></i>
                </span></a>
            </li>
            <li><a href="https://vk.com/gennadysx" target="_blank">
                <span class="fa-stack fa-2x ">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-vk fa-stack-1x fa-inverse"></i>
                </span></a>
            </li>
            <li><a href="https://github.com/GennadySX/" target="_blank">
                <span class="fa-stack fa-2x" >
                  <i class="fa fa-circle fa-stack-2x"></i>
